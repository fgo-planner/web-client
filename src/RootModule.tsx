...
const ResourcesModule = React.lazy(() => import('./modules/resources/ResourcesModule'));

const AuthenticatedModule = React.lazy(() => import('./modules/authenticated/AuthenticatedModule'));
