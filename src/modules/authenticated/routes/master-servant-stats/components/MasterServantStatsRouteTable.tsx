...
import { MasterServantStatPanelData, MasterServantStatPanelRow, MasterServantStatsRouteTableExpandablePanel } from './MasterServantStatsRouteTableExpandablePanel';
import { MasterServantStatsRouteTypes } from '../MasterServantStatsRouteTypes';

type Props = {
    stats: MasterServantStatsRouteTypes.Stats<Record<string, number>>;
...
export const StyleClassPrefix = 'MasterServantStatsRouteTable';

export const MasterServantStatsRouteTable = React.memo((props: Props) => {
    ...
    const expandablePanelNodes: ReactNode = [
        <MasterServantStatsRouteTableExpandablePanel
