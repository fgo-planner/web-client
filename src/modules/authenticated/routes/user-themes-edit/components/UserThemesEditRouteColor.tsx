import { MathUtils, Nullable } from '@fgo-planner/common-core';
...
import { UserThemesEditRouteColorPickerMenu } from './UserThemesEditRouteColorPickerMenu';
import { UserThemesEditRouteColorSwatch } from './UserThemesEditRouteColorSwatch';
...
const StyleClassPrefix = 'UserThemesEditRouteColor';
...
export const UserThemesEditRouteColor = React.memo((props: Props) => {
    ...
    return (
        <Box className={`${StyleClassPrefix}-root`} sx={StyleProps}>
            <div className={`${StyleClassPrefix}-color-swatch-container`}>
                <UserThemesEditRouteColorSwatch
            ...
            <UserThemesEditRouteColorPickerMenu
                color={color}
